...
import org.killbill.billing.plugin.purchase.ConfirmationRequest;
...
public class Confirmation {
    ...
    public List<InvoiceItem> insertCreditToUserAccount(ConfirmationRequest confirmationJson) {
        ...
        CallContext pluginCallContext = new PluginCallContext(PurchaseActivator.PLUGIN_NAME, DateTime.now(timeZone),
